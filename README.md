...
- Last modified: ons sep 27, 2023  01:01
- Sign: JN
...
step](#10-data-submission-to-public-databases).
...
3. Select the fields applicable. Pay attention to the mandatory fields and the
   ...
   [`ENA_default_sample_checklist.tsv`](doc/ENA-submission/ENA_default_sample_checklist.tsv),
...
[`ENA_default_sample_checklist_README.md`](doc/ENA-submission/ENA_default_sample_checklist_README.md).

**Important**

- For `sample_alias`, do not use special characters or white space, and make sure those entries are unique.
